...
export async function GET() {
  ...
  const example = [
    ["케어백 1세대", "케어백", "https://smartstore.naver.com/uddyu", "서양배", "CB1-013", 23000, 16900, 12675],
    ["케어백 1세대", "케어백", "", "비닐", "CB1-014", 22500, 14000, 10500],
    ["콩딱", "도어쿠션", "", "콩딱 A(1+1)", "KD-001", 23900, 15300, 11016],
  ];
